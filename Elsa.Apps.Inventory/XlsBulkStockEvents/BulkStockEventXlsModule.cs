...
namespace Elsa.Apps.Inventory.XlsBulkStockEvents
{
    public class BulkStockEventXlsModule : XlsImportExportModuleBase<StockEventXlsModel>
    {
        ...
        public BulkStockEventXlsModule(IStockEventRepository eventRepository, IMaterialBatchFacade batchFacade, IMaterialBatchRepository batchRepository, AmountProcessor amountProcessor, IMaterialRepository materialRepository, IDatabase db) : base(db)
        {
        ...
        protected override List<StockEventXlsModel> ExportData(out string exportFileName, IDatabase db)
        {
        ...
        protected override string ImportDataInTransaction(List<StockEventXlsModel> data, IDatabase db, ITransaction tx)
        {
