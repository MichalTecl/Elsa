...
namespace Elsa.Jobs.CrmMailPull.Infrastructure
{
    public class MailConversationSummarizer
    {
        ...
        public MailConversationSummarizer(ILog log, MailPullRepository repository, IChatGptClient ai)
        {
            _log = log;
        ...
        public MailConversationSummaryResult SummarizeConversation(int conversationId, string promptTemplate, bool skipAi, int minWordsForAiSummary = 50)
        {
            ...
            if (preparedMessages.Count == 0)
            {
                return new MailConversationSummaryResult
                {
                    ...
                    Summary = "Konverzace neobsahovala pouzitelny text pro automaticke shrnuti.",
                    UsedAi = false
                };
            }
            ...
            if (skipAi)
            {
                ...
                {
                    SubjectSummary = conversationSubject,
                    Summary = BuildDirectSummary(normalizedMessages),
                    UsedAi = false
                };
            }
            ...
            var prompt = BuildPrompt(promptTemplate, preparedMessages);
    ...
    public sealed class MailConversationSummaryResult
    {
        public string SubjectSummary { get; set; }
        public string Summary { get; set; }
