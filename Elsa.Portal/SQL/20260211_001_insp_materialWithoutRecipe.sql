...
CREATE OR ALTER   PROCEDURE [dbo].[insp_materialWithoutRecipe] (@sessionId INT, @projectId INT, @retryIssueId INT = null)
AS
BEGIN
	...
	*/
	...
	SELECT N'Suroviny/Obaly, které nejsou v žádných recepturách' IssueType,
	       'materialWoRecipe' + LTRIM(STR(m.Id)) IssueCode,
		   N'Materiál "' + m.Name + N'" není použit v žádné receptuře (a přitom je skladem)' [Message], 
