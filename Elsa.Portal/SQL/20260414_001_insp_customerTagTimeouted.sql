CREATE OR ALTER   PROCEDURE [dbo].[insp_customerTagTimeouted] (@sessionId INT, @projectId INT, @retryIssueId INT = null)
AS
BEGIN
...
/*
	...
	*/
	...
	SELECT N'Štítek "' + ISNULL(NULLIF(LTRIM(RTRIM(ctt.InspectorAlias)), ''), ctt.Name) + N'" po deadline' IssueType, 
