...
BEGIN
	...
	IF OBJECT_ID('tempdb..#AbandonedBatches') IS NOT NULL
    DROP TABLE #AbandonedBatches;

	SELECT *
	INTO #AbandonedBatches
	FROM vwAbandonedBatches ab
	WHERE ab.ProjectId = @projectId
	  AND ab.IsAbandoned = 1;
